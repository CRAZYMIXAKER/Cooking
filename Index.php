		...
		<section class="hero">
			<header class="header">
				...
				<div class="header__menu">
					...
					<a href="#" class="header__sign-up"> Регистрация </a>
					<a href="#" class="header__sign-in"> Вход </a>
				</div>
			</header>
			<div class="main">
                ...
                <div class="recipe__desc">
                  <ul class="desc">
                    <li class="desc__item">
                      <img
                        src="./img/icons8-heart-208.png"
                        alt="Количество лайков рецепта"
                    ...
                    <li class="desc__item">
                      <img
                        src="./img/icons8-star-96.png"
                        alt="Количество добавлений рецепта"
                        class="desc__item-icon"
                      />
                    ...
                    <li class="desc__item">
                      <img
                        src="./img/icons8-delete-message-52.png"
                        alt="Количество сообщений рецепта"
                        class="desc__item-icon"
                      />
                    ...
                    <li class="desc__item">
                      <img
                        src="./img/icons8-eye-96.png"
                        alt="Количество просмотров рецепта"
                        class="desc__item-icon"
                      />
              ...
              <div class="recipe">
                <a href="" class="recipe__link-img">
                  <img
                    src="./img/Recipe/5.jpg"
                    alt="Рецепт"
                    class="recipe__img"
                  />
                </a>
                <div class="recipe__link-name">
                  123456789012345678901234567890122
                </div>
                <a class="recipe__link-author">
                  <img
                    src="./img/profile.png"
			...
			<div>
				<?php
				$stmt = $conn->query("select * from Users where IDUser=1");
				echo '<p>' . print_r($stmt->fetchAll(\PDO::FETCH_ASSOC)) . '</p>';
				?>
			</div>
		</section>
